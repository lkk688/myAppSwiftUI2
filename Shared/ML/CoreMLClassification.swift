...
class CoreMLClassification: ObservableObject {
    //CoreMLClassification singleton
    static let shared = CoreMLClassification()
    @Published var text: String?
    
    //let completion: (_ outputtext: String) -> Void
    ...
    lazy var classificationRequest: VNCoreMLRequest = {
        do {
            ...
            //let model = try VNCoreMLModel(for: MyImageClassifier1(configuration: config).model)
    ...
    func processClassifications(for request: VNRequest, error: Error?) {
        DispatchQueue.main.async {
            ...
            //self.completion(self.text ?? "No result")
        }
    }
}
